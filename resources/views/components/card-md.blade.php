...
<div class="w-full sm:basis-1/2 basis-full lg:basis-1/3 p-5">
    <div class="max-w-sm rounded-xl overflow-hidden shadow-lg mx-auto bg-white">
        ...
        <a href="" class="py-3 px-7 my-8 mx-auto max-w-xs bg-gray-300 text-gray-800 rounded-full block text-xl text-center font-semibold">View Details</a>
    </div>
</div>
